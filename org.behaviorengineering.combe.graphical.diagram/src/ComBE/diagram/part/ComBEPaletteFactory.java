...
public class ComBEPaletteFactory {
	...
	private PaletteContainer createObjects1Group() {
		PaletteDrawer paletteContainer = new PaletteDrawer(
				ComBE.diagram.part.Messages.Objects1Group_title);
	...
	private PaletteContainer createConnections2Group() {
		PaletteDrawer paletteContainer = new PaletteDrawer(
				ComBE.diagram.part.Messages.Connections2Group_title);
	...
	private ToolEntry createNode1CreationTool() {
		...
		NodeToolEntry entry = new NodeToolEntry(
				ComBE.diagram.part.Messages.Node1CreationTool_title,
				ComBE.diagram.part.Messages.Node1CreationTool_desc, types);
		entry.setId("createNode1CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(ComBE.diagram.providers.ComBEElementTypes
				.getImageDescriptor(ComBE.diagram.providers.ComBEElementTypes.StandardNode_3001));
	...
	private ToolEntry createAlternativeBranch2CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				ComBE.diagram.part.Messages.AlternativeBranch2CreationTool_title,
				ComBE.diagram.part.Messages.AlternativeBranch2CreationTool_desc,
				Collections
						.singletonList(ComBE.diagram.providers.ComBEElementTypes.AlternativeBranch_2001));
		entry.setId("createAlternativeBranch2CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(ComBE.diagram.providers.ComBEElementTypes
				.getImageDescriptor(ComBE.diagram.providers.ComBEElementTypes.AlternativeBranch_2001));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createParallelBranch3CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				ComBE.diagram.part.Messages.ParallelBranch3CreationTool_title,
				ComBE.diagram.part.Messages.ParallelBranch3CreationTool_desc,
				Collections
						.singletonList(ComBE.diagram.providers.ComBEElementTypes.ParallelBranch_2002));
		entry.setId("createParallelBranch3CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(ComBE.diagram.providers.ComBEElementTypes
				.getImageDescriptor(ComBE.diagram.providers.ComBEElementTypes.ParallelBranch_2002));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createEmptyNode4CreationTool() {
		...
		NodeToolEntry entry = new NodeToolEntry(
				ComBE.diagram.part.Messages.EmptyNode4CreationTool_title,
				ComBE.diagram.part.Messages.EmptyNode4CreationTool_desc, types);
		entry.setId("createEmptyNode4CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(ComBE.diagram.providers.ComBEElementTypes
				.getImageDescriptor(ComBE.diagram.providers.ComBEElementTypes.EmptyNode_3002));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createConnection1CreationTool() {
		...
		LinkToolEntry entry = new LinkToolEntry(
				ComBE.diagram.part.Messages.Connection1CreationTool_title,
				ComBE.diagram.part.Messages.Connection1CreationTool_desc, types);
		entry.setId("createConnection1CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(ComBE.diagram.providers.ComBEElementTypes
				.getImageDescriptor(ComBE.diagram.providers.ComBEElementTypes.AlternativeBranchChildren_4001));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
