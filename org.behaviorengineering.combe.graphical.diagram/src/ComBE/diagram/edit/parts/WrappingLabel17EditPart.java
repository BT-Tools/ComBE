...
public class WrappingLabel17EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	protected String getLabelText() {
		...
		if (parserElement != null && getParser() != null) {
			text = getParser().getPrintString(new EObjectAdapter(parserElement), 4);
		}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ComBE.diagram.providers.ComBEParserProvider.getParser(ComBE.diagram.providers.ComBEElementTypes.StandardNode_3005, getParserElement(), ComBE.diagram.part.ComBEVisualIDRegistry.getType(ComBE.diagram.edit.parts.WrappingLabel17EditPart.VISUAL_ID));
		}
		return parser;
	}
