...
public class EmptyNode2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new ComBE.diagram.edit.policies.EmptyNode2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ComBE.diagram.edit.policies.EmptyNode2CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ComBE.diagram.edit.parts.EmptyNodeLabel2EditPart) {
			((ComBE.diagram.edit.parts.EmptyNodeLabel2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureEmptyNodeLabelLabelFigure());
			return true;
		}
		if (childEditPart instanceof ComBE.diagram.edit.parts.WrappingLabel12EditPart) {
			((ComBE.diagram.edit.parts.WrappingLabel12EditPart) childEditPart)
					.setLabel(getPrimaryShape()
