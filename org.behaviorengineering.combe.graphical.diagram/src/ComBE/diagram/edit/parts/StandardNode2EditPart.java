...
public class StandardNode2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new ComBE.diagram.edit.policies.StandardNode2ItemSemanticEditPolicy());
		installEditPolicy(
				EditPolicyRoles.CANONICAL_ROLE,
				new ComBE.diagram.edit.policies.StandardNode2CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ComBE.diagram.edit.parts.WrappingLabel10EditPart) {
			((ComBE.diagram.edit.parts.WrappingLabel10EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureNodeTraceabilityStatusLabelFigure());
			return true;
		}
		if (childEditPart instanceof ComBE.diagram.edit.parts.WrappingLabel11EditPart) {
			((ComBE.diagram.edit.parts.WrappingLabel11EditPart) childEditPart)
					.setLabel(getPrimaryShape()
