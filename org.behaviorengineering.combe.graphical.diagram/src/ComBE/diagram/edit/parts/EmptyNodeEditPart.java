...
public class EmptyNodeEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new ComBE.diagram.edit.policies.EmptyNodeItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ComBE.diagram.edit.policies.EmptyNodeCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ComBE.diagram.edit.parts.EmptyNodeLabelEditPart) {
			((ComBE.diagram.edit.parts.EmptyNodeLabelEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureEmptyNodeLabelLabelFigure());
			return true;
		}
		if (childEditPart instanceof ComBE.diagram.edit.parts.WrappingLabel6EditPart) {
			((ComBE.diagram.edit.parts.WrappingLabel6EditPart) childEditPart)
					.setLabel(getPrimaryShape()
