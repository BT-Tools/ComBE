...
public class StandardNodeEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new ComBE.diagram.edit.policies.StandardNodeItemSemanticEditPolicy());
		installEditPolicy(
				EditPolicyRoles.CANONICAL_ROLE,
				new ComBE.diagram.edit.policies.StandardNodeCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ComBE.diagram.edit.parts.WrappingLabel4EditPart) {
			((ComBE.diagram.edit.parts.WrappingLabel4EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureNodeTraceabilityStatusLabelFigure());
			return true;
		}
		if (childEditPart instanceof ComBE.diagram.edit.parts.WrappingLabel5EditPart) {
			((ComBE.diagram.edit.parts.WrappingLabel5EditPart) childEditPart)
					.setLabel(getPrimaryShape()
