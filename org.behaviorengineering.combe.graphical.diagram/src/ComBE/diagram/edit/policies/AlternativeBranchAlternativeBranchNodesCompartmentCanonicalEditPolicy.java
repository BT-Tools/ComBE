 ...
 * @generated
 */
public class AlternativeBranchAlternativeBranchNodesCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<ComBE.diagram.part.ComBENodeDescriptor> childDescriptors = ComBE.diagram.part.ComBEDiagramUpdater
				.getAlternativeBranchAlternativeBranchNodesCompartment_7001SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		int visualID = ComBE.diagram.part.ComBEVisualIDRegistry
				.getVisualID(view);
		return visualID == ComBE.diagram.edit.parts.StandardNodeEditPart.VISUAL_ID
				|| visualID == ComBE.diagram.edit.parts.EmptyNodeEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<ComBE.diagram.part.ComBENodeDescriptor> childDescriptors = ComBE.diagram.part.ComBEDiagramUpdater
				.getAlternativeBranchAlternativeBranchNodesCompartment_7001SemanticChildren((View) getHost()
						.getModel());
